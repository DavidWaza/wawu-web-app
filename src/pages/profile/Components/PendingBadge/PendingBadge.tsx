...
const PendingContractBanner = ({ showLink, days }: any) => {
  ...
  return (
    <div className="flex flex-row items-center h-[44px] rounded-md border border-[#ddd] px-4 gap-1 justify-between bg-[#FFF7ED] my-5">
      <div className="flex flex-row items-center gap-1">
        <TriangleAlert className="w-[15px] h-[13.5px]" color="#EA580C" />
        <p className="text-sm text-[#352C76] font-medium">
      ...
      {showLink && (
        <Link
          ...
          className="text-sm text-[#352C76] font-medium underline"
        >
          Update Profile
        </Link>
      )}
